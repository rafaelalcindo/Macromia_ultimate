...
if($servico != " " && $estado != " " && $cidade != " " && $id_foto != null){
	...
	//	echo "<h3>No momento estamos sem eventos</h3>";
		...
		if($lista_cli_01_count > 1 && $pg <= $lista_cli_01_count){
			echo "<div class='clearfix colelem' id='u506654'>";
	   		if($pg > 1){
	   			echo "
			        <div class='rounded-corners clearfix grpelem' id='u506655-4' style='cursor: pointer;' onclick='paginacao_pedidos($pg - 1, true)' data-muse-uid='U506655' data-muse-type='txt_frame'><!-- content -->
	   		...
	   		if($pg < $lista_cli_01_count){
	   			...
	   			echo "
	   				<div class='rounded-corners clearfix grpelem' id='u506656-4' style='cursor: pointer;' onclick='paginacao_pedidos($pg + 1, true)' data-muse-uid='U506656' data-muse-type='txt_frame'><!-- content -->
	...
	//echo "<br/>Entrou no else 6, val estado".$estado.", id_foto: ".$id_foto." <br/>";
