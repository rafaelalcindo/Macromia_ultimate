...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.watch.js", "webpro.js", "musewpdisclosure.js", "jquery.museresponsive.js", "require.js", "filtro.css"], "outOfDate":[]};
  ...
  <link rel="stylesheet" type="text/css" href="css/filtro.css?crc=3788489661" id="pagesheet"/>
  <!-- IE-only CSS -->
  <!--[if lt IE 9]>
  ...
  <link rel="stylesheet" type="text/css" href="css/nomq_filtro.css?crc=332961093" id="nomq_pagesheet"/>
  <![endif]-->
  <!-- Other scripts -->
  <script type="text/javascript">
                  ...
                  if(res == 'true'){
                      $.ajax({
                          ...
                          beforeSend: function(){
                           ...
                           /* setTimeout(function(){
                                $('#u468565-4').css('cursor','not-allowed');
                                $('#u468565-4').die('click');
                            }, 10000);*/
